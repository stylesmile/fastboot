...
//    public SwaggerResourcesInfo resources() {
...
//        resourcesInfo.setSwaggerVersion("3.0.0");
...
//    public SwaggerResourcesInfo api3() throws IOException {
//        SwaggerResourcesInfo resourcesInfo = new SwaggerResourcesInfo();
//        resourcesInfo.setName("group1");
//        resourcesInfo.setUrl("/v3/api-docs/group1");
//        resourcesInfo.setSwaggerVersion("3.0.0");
//        resourcesInfo.setLocation("/v3/api-docs/group1");
//        return resourcesInfo;
//    }
//    /**
//     * swagger 获取分组接口数据
...
//        return OpenApi3Utils.getOpenapi3Json("group1");
