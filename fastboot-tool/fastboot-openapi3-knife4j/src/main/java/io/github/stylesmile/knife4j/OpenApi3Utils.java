...
//            paths.add(methodMap);
        ...
        openApi3Info.setInfo(new Info());

        List<io.github.stylesmile.knife4j.openapi3.Tag> tags = new ArrayList<>();
        tags.add(new io.github.stylesmile.knife4j.openapi3.Tag());
        openApi3Info.setTags(tags);
