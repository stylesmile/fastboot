...
public class Constant {
    ...
    public static final String START_CLASS_ANNOTATION2 = "org.noear.solon.annotation.SolonMain";
    public static final String START_CLASS_ANNOTATION = "io.github.stylesmile.annotation.Fastboot";
