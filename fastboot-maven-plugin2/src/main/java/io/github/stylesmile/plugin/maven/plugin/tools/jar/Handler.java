...
public class Handler extends URLStreamHandler {
	...
	protected URLConnection openConnection(URL url) throws IOException {
		if (this.jarFile != null
			...
			return io.github.stylesmile.plugin.maven.plugin.tools.jar.JarURLConnection.get(url, this.jarFile);
		}
		try {
			return io.github.stylesmile.plugin.maven.plugin.tools.jar.JarURLConnection.get(url, getRootJarFileFromUrl(url));
		}
		catch (Exception ex) {
