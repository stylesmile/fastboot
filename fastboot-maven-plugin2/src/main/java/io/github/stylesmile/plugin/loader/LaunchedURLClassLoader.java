...
import io.github.stylesmile.plugin.loader.jar.Handler;
...
public class LaunchedURLClassLoader extends URLClassLoader {
	...
	private void clearCache(URLConnection connection) throws IOException {
		...
		if (jarFile instanceof io.github.stylesmile.plugin.loader.jar.JarFile) {
			((io.github.stylesmile.plugin.loader.jar.JarFile) jarFile).clearCache();
		}
	}
