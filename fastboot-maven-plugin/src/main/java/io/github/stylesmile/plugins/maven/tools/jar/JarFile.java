...
import io.github.stylesmile.plugins.maven.tools.Constant;
import io.github.stylesmile.plugins.maven.tools.data.RandomAccessData;
import io.github.stylesmile.plugins.maven.tools.data.RandomAccessDataFile;
...
public class JarFile extends java.util.jar.JarFile {
	...
	private static final String HANDLERS_PACKAGE = Constant.HEAD_PACKAGE;
