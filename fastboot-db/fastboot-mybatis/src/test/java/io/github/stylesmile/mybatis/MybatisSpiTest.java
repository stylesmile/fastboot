...
/**
 * Verify SPI registration for MybatisPlugin.
 */
public class MybatisSpiTest {
    ...
    public void testSpiFileExists() throws Exception {
        ...
        assertTrue("SPI file should contain MybatisPlugin",
                content.contains("io.github.stylesmile.mybatis.MybatisPlugin"));
    }
}