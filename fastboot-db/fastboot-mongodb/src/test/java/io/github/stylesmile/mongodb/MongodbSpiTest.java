...
/**
 * Verify SPI registration for MongodbPlugin.
 */
public class MongodbSpiTest {
    ...
    public void testSpiFileExists() throws Exception {
        ...
        assertTrue("SPI file should contain MongodbPlugin",
                content.contains("io.github.stylesmile.mongodb.MongodbPlugin"));
    }
}